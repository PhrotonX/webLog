...
Route::post('user/image/add', 'App\Http\Controllers\UserProfilePictureUploadController@add')->name('user.image.add');
Route::post('user/image/store/{requestName}', 'App\Http\Controllers\ImageUploadController@store')->name('user.image.store');
Route::get('user/image/view', 'App\Http\Controllers\UserProfilePictureUploadController@view')->name('user.image.view');
